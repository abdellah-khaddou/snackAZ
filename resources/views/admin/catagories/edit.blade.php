...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container">
            <form enctype="multipart/form-data" method="POST" action="{{ route('admin.catagories.update',$catagory->id) }}">
                {{csrf_field()}}
                {{method_field('put')}}
                ...
                <div class="row">
                    ...
                    <div class=" input-group input-group-icon ">
                        <input class="@error('name') is-invalid @enderror" name="name" type="text" value="{{$catagory->name}}"/>
