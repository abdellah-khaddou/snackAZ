    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($client){
                return view('admin.clients.actions.action',compact('client'))->render();
            });
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::computed('address')
                ...
                ->orderable(true)
                ->searchable(true),
            Column::computed('sold_argent')
                ->addClass('text-center')
                ->title(trans(("site.sold_argent")))
                ->orderable(true)
                ->searchable(true),
            Column::computed('sold_point')
                ->addClass('text-center')
                ->title(trans(("site.sold_point")))
                ->orderable(true)
                ->searchable(true),
