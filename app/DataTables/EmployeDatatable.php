...
class EmployeDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($employe){
                return view('admin.employes.actions.action',compact('employe'))->render();
            });
    }
    ...
    public function html()
    {
        ...
        return $this->builder()
            ->setTableId('employedatatable-table')
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::computed('phone')
                ->addClass('text-center')
                ->title(trans(("site.phone")))
                ->orderable(true)
                ->searchable(true),
            Column::computed('cin')
                ->addClass('text-center')
                ->title(trans(("site.cin")))
                ->orderable(true)
                ->searchable(true),
            Column::computed('address')
                ...
                ->orderable(true)
                ->searchable(true),
            Column::computed('sold')
                ->addClass('text-center')
                ->title(trans(("site.sold")))
                ->orderable(true)
                ->searchable(true),
            Column::computed('gard')
                ->addClass('text-center')
                ->title(trans(("site.gard")))
                ->orderable(true)
                ->searchable(true),
